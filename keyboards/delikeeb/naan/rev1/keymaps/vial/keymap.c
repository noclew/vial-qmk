...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_all(
        ...
        KC_LCTL,    KC_LGUI,    KC_LALT,    MO(2),      KC_SPC,     KC_SPC,     KC_SPC,     MO(3),      KC_RALT,    KC_DOWN,    KC_LEFT,    KC_RGHT
    ),
    ...
    [1] = LAYOUT_all(
        ...
        _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,
        _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,
        KC_LCTL,    _______,    MO(2)  ,    KC_LALT,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______
    ...
    [2] = LAYOUT_all(
        ...
        KC_EQL ,    KC_0   ,    KC_4   ,    KC_5   ,    KC_6   ,    KC_MINS,    KC_UNDS,    KC_LPRN,    KC_RPRN,    KC_HASH,    KC_DQUO,    _______,
        KC_ENT ,    KC_PAST,    KC_1   ,    KC_2   ,    KC_3   ,    KC_DOT,     KC_DLR ,    KC_LCBR,    KC_RCBR,    KC_AMPR,    KC_PERC,    _______,    _______,
    ...
    [3] = LAYOUT_all(
        ...
        _______,    _______,    _______,    _______,    _______,    _______,    KC_BSPC,    KC_LEFT,    KC_DOWN,    KC_RGHT,    KC_QUOT,    _______,
        _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_PGUP,    _______,    _______,    KC_PGDN,    _______,    _______,
        _______,    _______,    _______,    MO(4)  ,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______
    ),
